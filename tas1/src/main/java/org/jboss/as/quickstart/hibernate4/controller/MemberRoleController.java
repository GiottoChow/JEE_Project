...
import org.jboss.as.quickstart.hibernate4.service.MemberRoleRegistration;
...
public class MemberRoleController {
	...
	private MemberRole_bkup newMemberRole;

	@Produces
	@Named
	public MemberRole_bkup getNewMemberRole() {
	...
	@PostConstruct
	public void initNewMemberRole() {
		newMemberRole = new MemberRole_bkup();
		newMemberRole.setRoleBkup(new Role_bkup());
	}

	public void register() {
		try {
			memberRoleRegistration.register(newMemberRole);
