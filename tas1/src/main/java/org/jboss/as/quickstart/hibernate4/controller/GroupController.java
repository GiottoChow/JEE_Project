...
import org.jboss.as.quickstart.hibernate4.model.Group;
import org.jboss.as.quickstart.hibernate4.service.GroupRegistration;
...
public class GroupController {
	...
	public void initNewgroup() {
		newgroup = new Group();
		// newgroup.setParentGroup(new Group());
	}

	public void register() {
		try {
			groupRegistration.register(newgroup);
